...
BuildRight Hardware gift cards are the easy gift for any DIYer, homeowner, or contractor. They never expire, work in store and online, and come in physical and digital formats. This page covers denominations, how and where to use them, balance checks, lost/stolen policy, and bulk/corporate ordering.
...
- In store at any BuildRight Hardware location
...
You can **combine multiple gift cards** on a single order, and use a gift card alongside another payment method (such as a credit card) to cover any remaining balance. If your order total is less than the card balance, the remaining value stays on the card for next time.

## What Gift Cards Cannot Be Used For

- Purchasing **other gift cards**
- **Propane** tank purchases or exchanges
- Paying down a **BuildRight Credit Card** balance
- They are **not redeemable for cash** except where required by provincial law

## No Expiry and No Fees

- BuildRight gift cards **never expire**.
- There are **no dormancy, maintenance, or activation fees** — the full value stays available until you spend it.
...
Your remaining balance also appears on your receipt after each in-store purchase made with the card.

## Using a Gift Card Online

1. Add items to your cart and proceed to checkout.
2. In the payment step, enter your **gift card number and PIN**.
3. Apply additional gift cards if you have them, then choose another payment method for any remaining balance.

## Returns Paid with a Gift Card

When you return an item that was paid for with a gift card, the refund is issued **back to a gift card** (a new card or a reload of the original), per the [Refund Policy](refunds.md). Gift cards themselves are **non-returnable and non-refundable**.
...
BuildRight Hardware offers volume gift card programs for businesses:
...
- **Custom branding** and custom denominations available for larger orders.
